...
const GOOGLE_API_KEY = "AIzaSyD0JrnsiFqlO1dbblo-9Cf-QPHhNqeKlK0";
...
export async function getHealthChatResponse(userMessage: string, chatId: string): Promise<string> {
  try {
